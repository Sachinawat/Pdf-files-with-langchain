...
import os
os.environ["OPENAI_API_KEY"] = "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"
...
reader = PdfReader('/content/gdrive/MyDrive/NLP/chatbot with pdf/2023_GPT4All_Technical_Report.pdf')
